pipeline {
  ...
  stages {
    ...
    stage('Test') {
      steps {
        bat(script: '"C:\\Program Files (x86)\\NUnit.org\\nunit-console\\nunit3-console.exe" C:\\Windows\\System32\\config\\systemprofile\\AppData\\Local\\Jenkins.jenkins\\workspace\\TestsForCI_master\\TestsForCI\\bin\\Debug\\TestsForCI.exe', label: 'Start nunit', returnStatus: true)
      }
    }
