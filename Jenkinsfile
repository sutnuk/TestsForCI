pipeline {
  ...
  stages {
    ...
    stage('Test') {
      steps {
        bat(script: 'TestsForCI\\packages\\NUnit.ConsoleRunner.3.11.1\\tools\\nunit3-console.exe TestsForCI\\TestsForCI\\bin\\Debug\\TestsForCI.exe', label: 'Start nunit', returnStatus: true)
      }
    }
